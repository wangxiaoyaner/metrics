...
public interface Constants {
	...
	public final static String NUM_PUBLIC_METHODS = "NPM";
	public static final String ENCAPSULATION_RATIO = "ENCAP";
	public static final String NUM_LOCALS = "NL";
	public static final String NUM_FIELDS_USED = "NFA";
	public static final String NUM_METHODS_CALLED = "NMC";
	public static final String NUM_EXT_METHODS_CALLED = "NMCE";
	public static final String NUM_INT_METHODS_CALLED = "NMCI";
